...
import { SystemID, DomainID, makeSystemID } from '../../SHARED/identifiers.ts';
...
import { ConflictRecord } from '../GOVERNANCE/conflict.ts';
import { DomainChangeResult } from '../DOMAIN-GATEWAY/contracts/common.ts';
