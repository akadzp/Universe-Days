...
import { DomainID, SystemID, makeDomainID } from '../../SHARED/identifiers.ts';
...
import { DomainGateway } from '../DOMAIN-GATEWAY/gateway.ts';
import { DomainChangeRequest, DomainChangeResult, DomainQueryResult } from '../DOMAIN-GATEWAY/contracts/common.ts';
