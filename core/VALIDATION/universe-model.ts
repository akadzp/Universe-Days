...
import { isKnownDomain } from '../RUNTIME/GOVERNANCE/ownership.ts';
import { validateActorClassification } from '../CHARACTER/actor.ts';
import { validateCharacterProfile } from '../CHARACTER/character-profile.ts';
import { validateBehavior } from '../CHARACTER/behavior.ts';
import { CharacterStateEntity, validateCharacterState } from '../DOMAIN/STATE/character-state.ts';
import { CharacterStyleEntity, validateCharacterStyle } from '../CHARACTER/character-style.ts';
import { AuthorityLevel, EntityType } from '../SHARED/model-types.ts';
import { ObjectDataSource, ObjectRelationEntity } from '../OBJECT/object.ts';
import { LocationDataSource, LocationEntity } from '../DOMAIN/LOCATION/location.ts';
