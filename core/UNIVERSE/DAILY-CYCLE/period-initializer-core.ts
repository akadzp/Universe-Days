/** Pure Daily-Cycle period initialization primitive.
 *
 * This module deliberately does not import continuation/finalization/gate
 * orchestration. It is the lower-level initializer used to keep the lifecycle
...
export function initializePeriodCore(params: InitializePeriodParams): Result<UniversePeriodContext, { code: EngineErrorCode; message: string }> {
    if (!params.startTime) {
