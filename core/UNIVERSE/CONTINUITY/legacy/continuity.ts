...
import type { EntityIdentity } from '../../../SHARED/identity.ts';
...
import { makeDomainID, makeEntityID, makeSystemID, EntityID } from '../../../SHARED/identifiers.ts';
import { TemporalStatus } from '../../../RUNTIME/TEMPORAL/types.ts';
import { ActorDataSource } from '../../../CHARACTER/actor.ts';
import type { UniverseModel } from '../../CANON/universe.ts';
import type { CharacterEntity } from '../../../CHARACTER/character.ts';
