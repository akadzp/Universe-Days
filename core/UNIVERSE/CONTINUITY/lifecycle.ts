...
import { GenericStateMachine } from '../../RUNTIME/ENGINE/state-machine.ts';
import { Result, success, failure } from '../../SHARED/result.ts';
import { EngineErrorCode } from '../../SHARED/errors.ts';
import { ContinuityStatus, ContinuityIdentity } from '../../UNIVERSE/CONTINUITY/continuity-model.ts';
import { TransitionType, Transition } from '../../UNIVERSE/CONTINUITY/transition.ts';
