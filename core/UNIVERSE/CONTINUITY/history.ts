...
import { ContinuityIdentity, EffectiveTime, RevisionMetadata } from '../../UNIVERSE/CONTINUITY/continuity-model.ts';
import { Transition } from '../../UNIVERSE/CONTINUITY/transition.ts';
import { ContinuityValidationResult } from '../../UNIVERSE/CONTINUITY/result.ts';
