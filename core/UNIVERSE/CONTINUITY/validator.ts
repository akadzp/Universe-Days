...
import { RuleEvaluator } from '../../RUNTIME/ENGINE/rule-evaluator.ts';
import { RuntimeRule, RuleEvaluationStatus } from '../../RULES/types.ts';
import { ConditionReference, ConditionReferenceValidator } from '../../UNIVERSE/CONTINUITY/condition-reference.ts';
import {
  ContinuityItem,
  ContinuityIdentity,
  ...
  ContinuityStatus,
  EffectiveTime
} from '../../UNIVERSE/CONTINUITY/continuity-model.ts';
...
import { ContinuityDependencyEvaluator } from '../../UNIVERSE/CONTINUITY/dependency.ts';
