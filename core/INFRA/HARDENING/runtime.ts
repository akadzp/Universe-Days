import { PlatformResult, err, ok } from '../../SHARED/platform.ts';
import { HardeningPolicy, defaultHardeningPolicy } from '../../INFRA/HARDENING/policy.ts';
import { RuntimeGuards } from '../../INFRA/HARDENING/guards.ts';
